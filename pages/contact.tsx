...
const Contact = () => {
    ...
    return (
        <Box>
            ...
            <Typography  sx={{mb: 2,fontWeight:'bold'}} variant={'h4'}>Pour vous, clients </Typography>
            <Typography  sx={{mb: 2}} variant={'h5'}>Des questions à propos de votre commande ? </Typography>
            ...
            <Typography  sx={{mb: 2}}>Vous avez une question et souhaitez contacter FaceBouffe ? Cliquez ici pour entrer en contact
                avec nos équipes </Typography>

            <Typography  sx={{mb: 2}} variant={'h4'}>Pour vous, restaurants ou épiceries partenaires </Typography>
            <Typography  sx={{mb: 2}}>Pour toute question ou demande, veuillez nous contacter via la rubrique "Aide" de votre portail
                Hub.
                Si vous n'êtes pas encore partenaire, nous vous invitons à vous rendre sur cette page. </Typography>

            <Typography  sx={{mb: 2}}  variant={'h4'}>Pour vous, médias </Typography>
            <Typography  sx={{mb: 2}}>Pour toutes information, interview ou demande presse, veuillez nous écrire à
